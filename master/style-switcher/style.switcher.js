...
var styleSwitcher = {
	...
	build: function() {
		...
		this.container.find("div.options-links.website-type a").click(function(e) {
			...
			_gaq.push(['_trackEvent', 'Style Switcher', 'Website Type', $(this).attr("data-website-type")]);
	...
	setColor: function(color) {
		...
		if(this.initialized)
			_gaq.push(['_trackEvent', 'Style Switcher', 'Color', color]);
	...
	setLayoutStyle: function(style, refresh) {
		...
		if(this.initialized)
			_gaq.push(['_trackEvent', 'Style Switcher', 'Layout Style', style]);
	...
	setPattern: function(pattern) {
		...
		if(this.initialized)
			_gaq.push(['_trackEvent', 'Style Switcher', 'Background Pattern', pattern]);
	...
	reset: function() {
		...
		if(this.initialized)
			_gaq.push(['_trackEvent', 'Style Switcher', 'Reset']);
	...
	getCss: function() {
		...
		if(this.initialized)
			_gaq.push(['_trackEvent', 'Style Switcher', 'Get Css']);
